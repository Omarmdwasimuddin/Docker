...
#### [NextJS: docker-compose.yaml](https://github.com/Omarmdwasimuddin/NextJS-Docker-Compose)
...
#### [Containerize a Next.js application: standalone approach (development mode (Dockerfile.dev + Compose Watch with hot-reload))]()
